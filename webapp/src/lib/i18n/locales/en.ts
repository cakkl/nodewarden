...
const en: Record<string, string> = {
  ...
  "txt_settings_preferences": "Preferences",
  ...
  "txt_email_verification_code_label": "Verification code",
  "txt_email_verification_submit": "Confirm",
  ...
  "txt_new_email": "New email address",
  "txt_settings_appearance": "Appearance",
  "txt_error_boundary_title": "This page could not be loaded",
  "txt_error_boundary_chunk_help": "A newer version of NodeWarden has been deployed. Reload to continue.",
  "txt_error_boundary_help": "Something went wrong while rendering this page. Reload to try again.",
  "txt_theme": "Theme",
  "txt_use_system_theme": "Use system theme",
  "txt_light_theme": "Light",
  "txt_dark_theme": "Dark",
  "txt_theme_saved_locally": "Choose a theme for your web vault.",
  "txt_display_language_help": "Language for the interface and for the emails sent to you.",
  ...
  "txt_backup_replace_confirm_message": "The current instance already contains data. Continue restoring and replace the current instance data with the selected backup after verification succeeds? Note: two-step login is rolled back to the state stored in that backup (authenticator key, recovery code, YubiKey, passkey 2FA), and every device is signed out. Confirm first that you can still sign in with the authenticator or recovery code from that backup.",
  ...
  "txt_server_error_cipher_key_invalid": "The cipher key sent by the client is not a valid encrypted string. Update the client and try again.",
  ...
  "txt_server_error_cannot_ban_self": "You cannot ban yourself.",
  "txt_server_error_cannot_delete_self": "You cannot delete yourself.",
  ...
  "txt_totp_secret_unavailable": "Two-step login is on, but no usable authenticator key could be shown, so the key and QR code are hidden. If you cannot sign in with your authenticator app, disable two-step login below and set it up again.",
  "txt_totp_verify_failed": "TOTP verify failed",
  "txt_totp_verify_success": "TOTP verified",
  ...
  "txt_uri_match_type": "Match detection",
  ...
  "txt_preferences_auto": "Auto ({value})",
  "txt_preferences_load_failed": "Failed to load preferences",
  "txt_preferences_save_failed": "Failed to save preferences",
  "txt_timezone": "Timezone",
  "txt_timezone_help": "Times in emails and in your vault are shown in this timezone.",
  ...
  "txt_log_action_account_email_verification_confirm": "Confirm email address",
  "txt_log_action_account_email_verification_send": "Send email verification code",
  ...
  "txt_log_action_account_webauthn_2fa_disable": "Disable passkey two-step login",
  ...
  "txt_log_action_account_yubikey_disable": "Disable YubiKey OTP",
  ...
  "txt_log_action_admin_mail_settings_update": "Update mail settings",
  "txt_log_action_admin_mail_test": "Send test email",
  "txt_log_action_admin_mail_test_failed": "Test email failed",
  ...
  "txt_log_action_auth_login_failed_bad_auth_request": "Login failed: auth request rejected",
  ...
  "txt_log_meta_deployed_at": "Deployed at",
  "txt_log_meta_deployment_id": "Deployment ID",
  "txt_log_meta_previous_version": "Previous version",
  ...
  "txt_log_action_account_api_key_view": "View API key",
  "txt_log_action_account_verify_devices_update_rejected": "Rejected new-device verification change",
  "txt_log_action_auth_client_ip_missing": "Login failed: missing client IP",
  "txt_log_action_backup_scheduled_skipped": "Scheduled backup skipped",
  "txt_log_action_device_lost_trust": "Device trust expired",
  "txt_log_action_device_register": "Register device",
  "txt_log_action_system_yubico_credentials_update": "Update Yubico validation credentials",
  "txt_log_reason_client_ip_missing": "Client IP missing",
  "txt_log_reason_email_auth_unsupported": "Email code two-step login not supported",
  "txt_log_reason_invalid_password": "Wrong password",
  "txt_log_reason_lease_held": "Lease held by another run",
  "txt_log_reason_new_device_verification_unsupported": "New-device verification not supported (no email delivery channel)",
  "txt_log_reason_no_admin_present": "No active administrator",
  "txt_log_reason_password_missing": "Password not provided",
  "txt_log_reason_rate_limit_unavailable": "Rate limiter unavailable",
  "txt_log_reason_security_stamp_mismatch": "Security stamp mismatch",
  "txt_log_reason_storage_or_worker_error": "Storage or Worker error",
  "txt_log_reason_temporarily_unavailable": "Temporarily unavailable",
  "txt_log_target_type_token_endpoint": "Token endpoint",
  "txt_log_trigger_local": "Local",
  "txt_log_trigger_two_factor_device_verification_settings": "Two-factor device verification settings",
  ...
  "txt_log_reason_too_soon": "Requested too soon",
  "txt_log_reason_hourly_limit": "Hourly limit reached",
  "txt_log_reason_daily_limit": "Daily limit reached",
  "txt_log_target_type_mail_settings": "Mail settings",
};
