...
const ru: Record<string, string> = {
  ...
  "txt_email_verification_send_code": "Отправить код",
  ...
  "txt_email_verification_unavailable_hint": "Сервер не может отправлять почту, поэтому адрес нельзя подтвердить.",
  ...
  "txt_cancel_verification": "Отменить подтверждение",
  ...
  "txt_log_action_account_api_key_view": "Просмотр API-ключа",
  "txt_log_action_account_email_verification_cancel": "Отмена подтверждения почты",
  ...
  "txt_log_action_auth_client_ip_missing": "Вход отклонён: отсутствует IP клиента",
  ...
  "txt_log_action_device_lost_trust": "Доверие к устройству потеряно",
  ...
  "txt_log_action_system_yubico_credentials_initialize": "Инициализация учётных данных API YubiKey",
  "txt_log_action_system_yubico_credentials_reconfigure": "Переконфигурация учётных данных API YubiKey",
  "txt_log_action_system_yubico_credentials_update": "Обновление учётных данных API YubiKey",
  ...
  "txt_log_reason_rate_limit_unavailable": "Служба ограничения запросов недоступна",
  ...
  "txt_mail_locale": "Язык писем",
  "txt_mail_locale_help": "Язык темы и текста писем.",
  "txt_mail_timezone": "Часовой пояс",
  "txt_mail_timezone_help": "Время в письмах показывается в этом часовом поясе."
};
