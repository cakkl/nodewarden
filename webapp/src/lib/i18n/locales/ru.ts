...
const ru: Record<string, string> = {
  ...
  "txt_password_generator": "Генератор паролей",
  "txt_password_generator_description": "Создайте надежный уникальный пароль локально на этом устройстве.",
  "txt_generator_type": "Тип генератора",
  "txt_passphrase": "Парольная фраза",
  "txt_generated_password": "Созданный пароль",
  "txt_password_strength": "Надежность",
  "txt_password_strength_weak": "Слабый",
  "txt_password_strength_fair": "Средний",
  "txt_password_strength_good": "Хороший",
  "txt_password_strength_strong": "Надежный",
  "txt_generator_security_note": "Генерация выполняется локально. Пароль никогда не отправляется на сервер.",
  "txt_generator_length": "Длина",
  "txt_generator_character_types": "Типы символов",
  "txt_generator_uppercase": "Заглавные буквы (A-Z)",
  "txt_generator_lowercase": "Строчные буквы (a-z)",
  "txt_generator_numbers": "Цифры (0-9)",
  "txt_generator_special": "Специальные символы (!@#$%^&*)",
  "txt_generator_minimum": "Минимум",
  "txt_generator_avoid_ambiguous": "Исключить похожие символы",
  "txt_generator_words": "Количество слов",
  "txt_generator_separator": "Разделитель слов",
  "txt_generator_capitalize": "С заглавной буквы",
  "txt_generator_include_number": "Добавить число",
  "txt_generated_value": "Созданное значение",
  "txt_generator_character_count": "Символов: {count}",
  "txt_generator_pin": "PIN-код",
  "txt_generator_pin_description": "Создаёт числовой PIN локально с криптографически стойкой случайностью.",
  "txt_generator_username": "Имя пользователя",
  "txt_generator_plus_addressed_email": "Email с плюс-адресацией",
  "txt_generator_catch_all_email": "Catch-all email",
  "txt_generator_email": "Адрес электронной почты",
  "txt_generator_domain": "Домен",
  "txt_generator_word_list": "Список слов",
  "txt_generator_eff_word_list": "Длинный список EFF",
  "txt_generator_custom_word_list": "Свой список слов",
  "txt_generator_custom_words": "Свои слова",
  "txt_generator_custom_words_placeholder": "Введите не менее двух слов через пробел, запятую или с новой строки",
  "txt_generator_long_word_username": "Имя из длинных слов",
  "txt_generator_custom_word": "Своё мнемоническое слово",
  "txt_generator_subdomain_email": "Email с поддоменом",
  "txt_generator_ssh_key": "SSH-ключ",
  "txt_generator_ssh_generating": "Создание SSH-ключа…",
  "txt_generator_ssh_error": "Этот браузер не поддерживает создание SSH-ключей.",
  "txt_generator_copy_public_key": "Копировать открытый ключ",
  "txt_generator_ssh_security_note": "Пара создаётся локально и не отправляется. Сохраните закрытый ключ сейчас; NodeWarden его не хранит.",
  "txt_generator_public_key": "Открытый ключ",
  "txt_generator_private_key": "Закрытый ключ — храните в тайне",
  "txt_generator_ssh_algorithm": "Алгоритм",
  "txt_generator_key_length": "Длина ключа",
  "txt_generator_ssh_comment": "Комментарий открытого ключа",
  "txt_generator_ssh_rsa_description": "RSA широко совместим. Используйте минимум 2048 бит; рекомендуется 4096.",
  "txt_generator_ssh_ed25519_description": "Ed25519 быстр, компактен и рекомендуется для современных SSH-клиентов.",
  "txt_generator_email_alias": "Почтовый псевдоним",
  "txt_generator_email_type": "Тип псевдонима",
  "txt_generator_email_required_hint": "Введите адрес электронной почты или домен, чтобы создать псевдоним.",
  "txt_generator_email_description": "Введённые данные остаются на устройстве и используются только для создания псевдонима.",
  "txt_generator_long_word_username_description": "Объедините одно или несколько длинных слов в запоминающееся имя пользователя.",
  ...
  "txt_settings_preferences": "Настройки",
  "txt_settings_account": "Аккаунт",
  ...
  "txt_email_verification_code_label": "Код подтверждения",
  "txt_email_verification_submit": "Подтвердить",
  ...
  "txt_new_email": "Новый адрес почты",
  "txt_settings_appearance": "Внешний вид",
  "txt_error_boundary_title": "Не удалось загрузить страницу",
  "txt_error_boundary_chunk_help": "Опубликована более новая версия NodeWarden. Перезагрузите страницу, чтобы продолжить.",
  "txt_error_boundary_help": "При отображении страницы произошла ошибка. Перезагрузите и попробуйте снова.",
  "txt_theme": "Тема",
  ...
  "txt_display_language_help": "Язык интерфейса и писем, отправляемых вам.",
  ...
  "txt_backup_replace_confirm_message": "Текущий экземпляр уже содержит данные. Продолжить восстановление и заменить текущие данные экземпляра выбранной резервной копией после успешной проверки? Внимание: двухэтапная проверка вернётся к состоянию из этой резервной копии (ключ аутентификатора, код восстановления, YubiKey, 2FA через ключ доступа), а все устройства будут разлогинены. Сначала убедитесь, что вы сможете войти с помощью аутентификатора или кода восстановления из этой копии.",
  ...
  "txt_server_error_cipher_key_invalid": "Ключ элемента, отправленный клиентом, не является допустимой зашифрованной строкой. Обновите клиент и повторите попытку.",
  ...
  "txt_server_error_cannot_ban_self": "Вы не можете заблокировать самого себя.",
  "txt_server_error_cannot_delete_self": "Вы не можете удалить самого себя.",
  ...
  "txt_totp_secret_unavailable": "Двухэтапная проверка включена, но пригодный ключ аутентификатора показать не удалось, поэтому ключ и QR-код скрыты. Если вы не можете войти через приложение-аутентификатор, отключите двухэтапную проверку ниже и настройте её заново.",
  "txt_totp_verify_failed": "Проверка TOTP не удалась",
  "txt_totp_verify_success": "TOTP подтверждён",
  ...
  "txt_uri_match_type": "Определение совпадения",
  ...
  "txt_preferences_auto": "Автоматически ({value})",
  "txt_preferences_load_failed": "Не удалось загрузить настройки",
  "txt_preferences_save_failed": "Не удалось сохранить настройки",
  "txt_timezone": "Часовой пояс",
  "txt_timezone_help": "Время в письмах и в хранилище показывается в этом часовом поясе.",
  ...
  "txt_log_action_account_email_verification_confirm": "Подтверждение адреса почты",
  "txt_log_action_account_email_verification_send": "Отправка кода подтверждения почты",
  ...
  "txt_log_action_account_webauthn_2fa_disable": "Отключение двухфакторной проверки ключом доступа",
  ...
  "txt_log_action_account_yubikey_disable": "Отключение YubiKey OTP",
  ...
  "txt_log_action_admin_mail_settings_update": "Обновление настроек почты",
  "txt_log_action_admin_mail_test": "Отправка тестового письма",
  "txt_log_action_admin_mail_test_failed": "Не удалось отправить тестовое письмо",
  ...
  "txt_log_action_auth_login_failed_bad_auth_request": "Ошибка входа: запрос авторизации отклонён",
  ...
  "txt_log_meta_deployed_at": "Время развёртывания",
  "txt_log_meta_deployment_id": "ID развёртывания",
  "txt_log_meta_previous_version": "Предыдущая версия",
  "txt_log_meta_version": "Версия",
  ...
  "txt_log_action_account_api_key_view": "Просмотр ключа API",
  "txt_log_action_account_verify_devices_update_rejected": "Отклонено изменение проверки новых устройств",
  "txt_log_action_auth_client_ip_missing": "Ошибка входа: отсутствует IP клиента",
  "txt_log_action_backup_scheduled_skipped": "Запланированное резервное копирование пропущено",
  "txt_log_action_device_lost_trust": "Доверие к устройству истекло",
  "txt_log_action_device_register": "Регистрация устройства",
  "txt_log_action_system_yubico_credentials_update": "Обновление учетных данных проверки Yubico",
  "txt_log_reason_client_ip_missing": "Отсутствует IP клиента",
  "txt_log_reason_email_auth_unsupported": "Двухэтапный вход по коду из письма не поддерживается",
  "txt_log_reason_invalid_password": "Неверный пароль",
  "txt_log_reason_lease_held": "Блокировка удерживается другим запуском",
  "txt_log_reason_new_device_verification_unsupported": "Проверка новых устройств не поддерживается (нет канала отправки почты)",
  "txt_log_reason_no_admin_present": "Нет активного администратора",
  "txt_log_reason_password_missing": "Пароль не указан",
  "txt_log_reason_rate_limit_unavailable": "Ограничитель запросов недоступен",
  "txt_log_reason_security_stamp_mismatch": "Несовпадение метки безопасности",
  "txt_log_reason_storage_or_worker_error": "Ошибка хранилища или Worker",
  "txt_log_reason_temporarily_unavailable": "Временно недоступно",
  "txt_log_target_type_token_endpoint": "Конечная точка токена",
  "txt_log_trigger_local": "Локально",
  "txt_log_trigger_two_factor_device_verification_settings": "Настройки проверки устройств двухэтапного входа",
  ...
  "nav_password_security": "Безопасность паролей",
  "txt_password_security": "Проверка безопасности паролей",
  "txt_password_security_privacy": "Пароли проверяются локально. После запуска в базу утечек передаётся только анонимный префикс хеша.",
  "txt_check_password_security": "Начать проверку",
  "txt_checking_password_security": "Проверка",
  "txt_recheck_password_security": "Проверить снова",
  "txt_password_security_ready": "Ваше хранилище готово к проверке безопасности.",
  "txt_password_security_no_login": "Нет паролей для входа, доступных для проверки.",
  "txt_password_security_manual": "Проверка запускается только по вашему выбору. Результаты остаются только на этой странице.",
  "txt_password_security_no_login_help": "Добавьте запись входа с паролем и вернитесь сюда для проверки.",
  "txt_exposed_passwords": "Скомпрометированы",
  "txt_reused_passwords": "Повторно используются",
  "txt_weak_passwords": "Слабые",
  "txt_passwords_checked": "Проверено",
  "txt_password_security_unavailable": "{count} проверок не смогли обратиться к базе утечек. Они не помечены безопасными.",
  "txt_password_security_not_checked": "Не проверено",
  "txt_password_exposed_count": "Найдено в {count} утечках",
  "txt_password_reused_count": "Используется {count} раз",
  "txt_weak_password": "Слабый пароль",
  "txt_no_password_risks": "Рисков паролей не найдено",
  "txt_open_vault": "Открыть хранилище",
  "txt_check_password_breach": "Проверить утечку",
  "txt_password_not_found_in_breaches": "Не найден в базе утечек",
  "txt_password_security_check_failed": "Не удалось завершить проверку утечки.",
  "txt_password_security_last_checked": "Последняя проверка: {value}",
  "txt_no_password_risks_in_filter": "В этой категории нет рисков для паролей",
  ...
  "txt_mail_configured": "Настроено",
  "txt_mail_sending_intro": "Настройте SMTP-сервер, чтобы NodeWarden мог отправлять письма.",
  "txt_mail_host": "Хост SMTP",
  "txt_mail_port": "Порт",
  "txt_mail_encryption_starttls": "STARTTLS (587 / 2587)",
  "txt_mail_encryption_implicit": "Неявный TLS (465 / 2465)",
  "txt_mail_username": "Имя пользователя",
  "txt_mail_password": "Пароль",
  "txt_mail_password_keep": "Оставьте пустым, чтобы сохранить текущий пароль",
  "txt_mail_from_address": "Адрес отправителя",
  "txt_mail_from_name": "Имя отправителя",
  "txt_mail_send_test": "Отправить тестовое письмо",
  "txt_mail_save_title": "Сохранить настройки почты",
  "txt_mail_settings_load_failed": "Не удалось загрузить настройки почты",
  "txt_mail_settings_save_failed": "Не удалось сохранить настройки почты",
  "txt_mail_settings_saved": "Настройки почты сохранены",
  "txt_mail_test_failed": "Не удалось отправить тестовое письмо",
  "txt_mail_test_sent": "Тестовое письмо отправлено на {email}",
  "txt_mail_error_timeout": "Почтовый сервер не ответил вовремя",
  "txt_mail_error_connect": "Не удалось подключиться к почтовому серверу. Проверьте хост и порт.",
  "txt_mail_error_auth": "Почтовый сервер отклонил сеанс. Проверьте порт и режим шифрования.",
  "txt_mail_error_auth_rejected": "Ошибка аутентификации. Проверьте имя пользователя и пароль.",
  "txt_mail_error_delivery": "Почтовый сервер отклонил письмо. Возможно, адрес отправителя не разрешён.",
  "txt_mail_encryption_inferred": "Шифрование: {mode}",
  "txt_mail": "Почта",
  "txt_mail_disable": "Отключить",
  "txt_mail_not_configured": "Не настроено",
  "txt_mail_config": "Настройка почты",
  "txt_log_reason_too_soon": "Запрошено слишком рано",
  "txt_log_reason_hourly_limit": "Достигнут часовой лимит",
  "txt_log_reason_daily_limit": "Достигнут дневной лимит",
  "txt_log_target_type_mail_settings": "Настройки почты",
};
