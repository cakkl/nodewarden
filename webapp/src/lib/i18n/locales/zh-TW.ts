...
const zhTW: Record<string, string> = {
  ...
  "txt_email_verification_send_code": "傳送驗證碼",
  ...
  "txt_email_verification_unavailable_hint": "本伺服器未設定郵件寄送，暫時無法驗證信箱。",
  ...
  "txt_log_action_account_email_verification_cancel": "取消電子郵件驗證",
  ...
  "txt_log_action_auth_client_ip_missing": "登入被拒：缺少用戶端 IP",
  ...
  "txt_log_action_backup_scheduled_skipped": "排程備份已跳過",
  ...
  "txt_log_action_device_lost_trust": "裝置信任失效",
  ...
  "txt_log_action_system_yubico_credentials_initialize": "初始化 YubiKey API 認證",
  "txt_log_action_system_yubico_credentials_reconfigure": "重新設定 YubiKey API 認證",
  "txt_log_action_system_yubico_credentials_update": "更新 YubiKey API 認證",
  ...
  "txt_log_reason_temporarily_unavailable": "服務暫時無法使用",
  ...
  "txt_mail_locale": "郵件語言",
  "txt_mail_locale_help": "郵件的主旨與內文使用的語言。",
  "txt_mail_timezone": "時區",
  "txt_mail_timezone_help": "郵件裡顯示的時間依此時區換算。"
};
