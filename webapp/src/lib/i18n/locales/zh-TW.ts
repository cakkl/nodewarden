...
const zhTW: Record<string, string> = {
  ...
  "txt_generator_type": "產生類型",
  "txt_passphrase": "密碼片語",
  "txt_generated_password": "已產生密碼",
  "txt_password_strength": "強度",
  "txt_password_strength_weak": "弱",
  "txt_password_strength_fair": "普通",
  "txt_password_strength_good": "良好",
  "txt_password_strength_strong": "強",
  "txt_generator_security_note": "產生程序僅在本機進行，密碼不會傳送到伺服器。",
  "txt_generator_length": "長度",
  "txt_generator_character_types": "字元類型",
  "txt_generator_uppercase": "大寫字母 (A-Z)",
  "txt_generator_lowercase": "小寫字母 (a-z)",
  "txt_generator_numbers": "數字 (0-9)",
  "txt_generator_special": "特殊字元 (!@#$%^&*)",
  "txt_generator_minimum": "最少數量",
  "txt_generator_avoid_ambiguous": "避免易混淆字元",
  "txt_generator_words": "單字數量",
  "txt_generator_separator": "單字分隔符號",
  "txt_generator_capitalize": "首字母大寫",
  "txt_generator_include_number": "包含數字",
  "txt_generated_value": "已產生內容",
  "txt_generator_character_count": "{count} 個字元",
  "txt_generator_pin": "PIN 碼",
  "txt_generator_pin_description": "使用密碼學安全亂數在本機產生純數字 PIN 碼。",
  "txt_generator_username": "使用者名稱",
  "txt_generator_plus_addressed_email": "加號別名信箱",
  "txt_generator_catch_all_email": "全域接收信箱",
  "txt_generator_email": "電子郵件地址",
  "txt_generator_domain": "網域",
  "txt_generator_word_list": "詞表",
  "txt_generator_eff_word_list": "EFF 長詞表",
  "txt_generator_custom_word_list": "自訂詞表",
  "txt_generator_custom_words": "自訂單字",
  "txt_generator_custom_words_placeholder": "輸入至少兩個單字，以空格、逗號或換行分隔",
  "txt_generator_long_word_username": "長單字使用者名稱",
  "txt_generator_custom_word": "自訂助記詞",
  "txt_generator_subdomain_email": "子網域電子郵件",
  "txt_generator_ssh_key": "SSH 金鑰",
  "txt_generator_ssh_generating": "正在產生 SSH 金鑰…",
  "txt_generator_ssh_error": "此瀏覽器不支援 SSH 金鑰產生。",
  "txt_generator_copy_public_key": "複製公鑰",
  "txt_generator_ssh_security_note": "金鑰組只在本機產生，不會傳送到伺服器。請立即儲存私鑰，NodeWarden 不會保留它。",
  "txt_generator_public_key": "公鑰",
  "txt_generator_private_key": "私鑰 — 請保密",
  "txt_generator_ssh_algorithm": "演算法",
  "txt_generator_key_length": "金鑰長度",
  "txt_generator_ssh_comment": "公鑰註解",
  "txt_generator_ssh_rsa_description": "RSA 相容性廣泛。請至少使用 2048 位元，建議 4096 位元。",
  "txt_generator_ssh_ed25519_description": "Ed25519 快速且精簡，建議用於現代 SSH 用戶端。",
  "txt_generator_email_alias": "信箱別名",
  "txt_generator_email_type": "信箱別名類型",
  "txt_generator_email_required_hint": "輸入電子郵件地址或網域後，即可產生別名。",
  "txt_generator_email_description": "輸入內容只保留在此裝置上，僅用於組合信箱別名。",
  "txt_generator_long_word_username_description": "將一個或多個長單字組合成容易記住的使用者名稱。",
  ...
  "txt_email_verification_code_label": "驗證碼",
  "txt_email_verification_submit": "確認",
  ...
  "txt_new_email": "新電子郵件地址",
  "txt_settings_appearance": "外觀",
  "txt_error_boundary_title": "頁面載入失敗",
  "txt_error_boundary_chunk_help": "NodeWarden 發佈了新版本，重新整理頁面即可繼續。",
  "txt_error_boundary_help": "轉譯這個頁面時發生錯誤，請重新整理後再試。",
  "txt_theme": "主題",
  "txt_use_system_theme": "使用系統主題",
  "txt_light_theme": "淺色",
  "txt_dark_theme": "深色",
  "txt_theme_saved_locally": "為您的網頁密碼庫選擇一個主題。",
  "txt_display_language_help": "介面與寄給你的郵件所用的語言。",
  ...
  "txt_backup_replace_confirm_message": "當前實例裡已經有數據。確認後，系統會先完成校驗與恢復準備，只有在恢復成功後才會用所選備份替換當前實例數據。是否繼續？注意：兩步驗證會回退到該備份中的狀態（驗證器密鑰、恢復碼、YubiKey、二步驗證通行密鑰），並強制註銷所有設備的登入會話；請先確認你仍能用該備份裡的驗證器或恢復碼登入。",
  ...
  "txt_server_error_cipher_key_invalid": "客戶端發來的條目密鑰不是合法的加密串。請更新客戶端後重試。",
  ...
  "txt_server_error_cannot_ban_self": "不能封鎖自己",
  "txt_server_error_cannot_delete_self": "不能刪除自己",
  ...
  "txt_totp_secret_unavailable": "兩步驗證已啟用，但無法顯示可用的驗證器密鑰，因此密鑰與二維碼已隱藏。若你無法用驗證器 App 登入，請在下方先停用，再重新啟用。",
  "txt_totp_verify_failed": "TOTP 驗證失敗",
  "txt_totp_verify_success": "TOTP 驗證通過",
  "txt_attachments": "附件",
  ...
  "txt_preferences_auto": "自動（{value}）",
  "txt_preferences_load_failed": "載入偏好失敗",
  "txt_preferences_save_failed": "儲存偏好失敗",
  "txt_timezone": "時區",
  "txt_timezone_help": "郵件與密碼庫裡的時間都按此時區顯示。",
  ...
  "txt_log_action_account_email_verification_confirm": "確認電子郵件地址",
  "txt_log_action_account_email_verification_send": "傳送電子郵件驗證碼",
  ...
  "txt_log_action_admin_mail_settings_update": "更新郵件設定",
  "txt_log_action_admin_mail_test": "傳送測試郵件",
  "txt_log_action_admin_mail_test_failed": "測試郵件傳送失敗",
  "txt_log_action_admin_user_delete": "刪除使用者",
  "txt_log_action_admin_user_status": "修改使用者狀態",
  "txt_log_action_attachment_delete": "刪除附件",
  "txt_log_action_auth_login_failed_bad_api_key": "登入失敗：API 金鑰錯誤",
  "txt_log_action_auth_login_failed_bad_auth_request": "登入失敗：授權請求驗證未通過",
  "txt_log_action_auth_login_failed_bad_password": "登入失敗：密碼錯誤",
  "txt_log_action_auth_login_failed_user_inactive": "登入失敗：帳號已停用",
  ...
  "txt_log_meta_deployed_at": "部署時間",
  "txt_log_meta_deployment_id": "部署 ID",
  "txt_log_meta_previous_version": "上一版本",
  "txt_log_meta_version": "版本",
  ...
  "txt_log_total": " 條總數",
  "txt_log_visible": " 條顯示",
  // 補：日誌中心先前會 humanize 成英文的標籤（動作 / 原因 / 觸發來源 / 目標類型）。
  // 集中放在這裡而不按字母序插入：平行分支也在按序補充同一批鍵，集中放可避免兩邊改動交錯衝突。
  "txt_log_action_account_api_key_view": "檢視 API 金鑰",
  "txt_log_action_account_verify_devices_update_rejected": "拒絕修改新裝置驗證",
  "txt_log_action_auth_client_ip_missing": "登入失敗：缺少用戶端 IP",
  "txt_log_action_backup_scheduled_skipped": "排程備份已略過",
  "txt_log_action_device_lost_trust": "裝置信任已失效",
  "txt_log_action_device_register": "註冊裝置",
  "txt_log_action_system_yubico_credentials_update": "更新 Yubico 驗證憑據",
  "txt_log_reason_client_ip_missing": "缺少用戶端 IP",
  "txt_log_reason_email_auth_unsupported": "不支援郵件驗證碼兩步驟登入",
  "txt_log_reason_invalid_password": "密碼錯誤",
  "txt_log_reason_lease_held": "已有工作占用租約",
  "txt_log_reason_new_device_verification_unsupported": "不支援新裝置驗證（沒有郵件傳送通道）",
  "txt_log_reason_no_admin_present": "沒有可用的管理員",
  "txt_log_reason_password_missing": "未提供密碼",
  "txt_log_reason_rate_limit_unavailable": "限流服務無法使用",
  "txt_log_reason_security_stamp_mismatch": "安全戳記不一致",
  "txt_log_reason_storage_or_worker_error": "儲存或 Worker 錯誤",
  "txt_log_reason_temporarily_unavailable": "暫時無法使用",
  "txt_log_target_type_token_endpoint": "權杖端點",
  "txt_log_trigger_local": "本機",
  "txt_log_trigger_two_factor_device_verification_settings": "兩步驟驗證的裝置驗證設定",
  "txt_metadata": "元資料",
  ...
  "txt_mail_configured": "已設定",
  "txt_mail_sending_intro": "設定 SMTP 伺服器後，NodeWarden 才能傳送郵件。",
  "txt_mail_host": "SMTP 主機",
  "txt_mail_port": "連接埠",
  "txt_mail_encryption_starttls": "STARTTLS（587 / 2587）",
  "txt_mail_encryption_implicit": "隱式 TLS（465 / 2465）",
  "txt_mail_username": "使用者名稱",
  "txt_mail_password": "密碼",
  "txt_mail_password_keep": "留空表示保留已儲存的密碼",
  "txt_mail_from_address": "寄件者地址",
  "txt_mail_from_name": "寄件者名稱",
  "txt_mail_send_test": "傳送測試郵件",
  "txt_mail_save_title": "儲存郵件設定",
  "txt_mail_settings_load_failed": "無法載入郵件設定",
  "txt_mail_settings_save_failed": "無法儲存郵件設定",
  "txt_mail_settings_saved": "郵件設定已儲存",
  "txt_mail_test_failed": "無法傳送測試郵件",
  "txt_mail_test_sent": "測試郵件已傳送至 {email}",
  "txt_mail_error_timeout": "郵件伺服器未在時限內回應",
  "txt_mail_error_connect": "無法連線郵件伺服器，請檢查主機與連接埠。",
  "txt_mail_error_auth": "郵件伺服器拒絕了本次工作階段，請檢查連接埠與加密方式。",
  "txt_mail_error_auth_rejected": "驗證失敗，請檢查使用者名稱與密碼。",
  "txt_mail_error_delivery": "郵件伺服器拒收了這封信，寄件者地址可能不被允許。",
  "txt_mail_encryption_inferred": "加密方式：{mode}",
  "txt_mail": "郵件",
  "txt_mail_disable": "停用",
  "txt_mail_not_configured": "未設定",
  "txt_mail_config": "郵件設定",
  "txt_log_reason_too_soon": "請求過於頻繁",
  "txt_log_reason_hourly_limit": "已達每小時限額",
  "txt_log_reason_daily_limit": "已達每日限額",
  "txt_log_target_type_mail_settings": "郵件設定",
};
