...
const es: Record<string, string> = {
  ...
  "txt_password_generator": "Generador de contraseñas",
  "txt_password_generator_description": "Crea una contraseña única y segura localmente en este dispositivo.",
  "txt_generator_type": "Tipo de generador",
  "txt_passphrase": "Frase de contraseña",
  "txt_generated_password": "Contraseña generada",
  "txt_password_strength": "Seguridad",
  "txt_password_strength_weak": "Débil",
  "txt_password_strength_fair": "Regular",
  "txt_password_strength_good": "Buena",
  "txt_password_strength_strong": "Fuerte",
  "txt_generator_security_note": "La generación se realiza localmente. Tu contraseña nunca se envía al servidor.",
  "txt_generator_length": "Longitud",
  "txt_generator_character_types": "Tipos de caracteres",
  "txt_generator_uppercase": "Mayúsculas (A-Z)",
  "txt_generator_lowercase": "Minúsculas (a-z)",
  "txt_generator_numbers": "Números (0-9)",
  "txt_generator_special": "Caracteres especiales (!@#$%^&*)",
  "txt_generator_minimum": "Mínimo",
  "txt_generator_avoid_ambiguous": "Evitar caracteres ambiguos",
  "txt_generator_words": "Número de palabras",
  "txt_generator_separator": "Separador de palabras",
  "txt_generator_capitalize": "Usar mayúsculas",
  "txt_generator_include_number": "Incluir un número",
  "txt_generated_value": "Valor generado",
  "txt_generator_character_count": "{count} caracteres",
  "txt_generator_pin": "PIN",
  "txt_generator_pin_description": "Genera localmente un PIN numérico con aleatoriedad criptográficamente segura.",
  "txt_generator_username": "Nombre de usuario",
  "txt_generator_plus_addressed_email": "Correo con direccionamiento plus",
  "txt_generator_catch_all_email": "Correo catch-all",
  "txt_generator_email": "Correo electrónico",
  "txt_generator_domain": "Dominio",
  "txt_generator_word_list": "Lista de palabras",
  "txt_generator_eff_word_list": "Lista larga de EFF",
  "txt_generator_custom_word_list": "Lista personalizada",
  "txt_generator_custom_words": "Palabras personalizadas",
  "txt_generator_custom_words_placeholder": "Introduce al menos dos palabras separadas por espacios, comas o líneas",
  "txt_generator_long_word_username": "Usuario de palabras largas",
  "txt_generator_custom_word": "Palabra auxiliar personalizada",
  "txt_generator_subdomain_email": "Correo de subdominio",
  "txt_generator_ssh_key": "Clave SSH",
  "txt_generator_ssh_generating": "Generando clave SSH…",
  "txt_generator_ssh_error": "Este navegador no admite la generación de claves SSH.",
  "txt_generator_copy_public_key": "Copiar clave pública",
  "txt_generator_ssh_security_note": "El par se genera localmente y no se envía. Guarda ahora la clave privada; NodeWarden no la conserva.",
  "txt_generator_public_key": "Clave pública",
  "txt_generator_private_key": "Clave privada — mantenla en secreto",
  "txt_generator_ssh_algorithm": "Algoritmo",
  "txt_generator_key_length": "Longitud de clave",
  "txt_generator_ssh_comment": "Comentario de clave pública",
  "txt_generator_ssh_rsa_description": "RSA es ampliamente compatible. Usa al menos 2048 bits; se recomiendan 4096.",
  "txt_generator_ssh_ed25519_description": "Ed25519 es rápido, compacto y recomendado para clientes SSH modernos.",
  "txt_generator_email_alias": "Alias de correo",
  "txt_generator_email_type": "Tipo de alias",
  "txt_generator_email_required_hint": "Introduce tu correo o dominio para generar un alias.",
  "txt_generator_email_description": "Los datos permanecen en este dispositivo y solo se usan para formar el alias.",
  "txt_generator_long_word_username_description": "Combina una o más palabras largas en un nombre de usuario fácil de recordar.",
  ...
  "txt_settings_preferences": "Preferencias",
  ...
  "txt_email_verification_code_label": "Código de verificación",
  "txt_email_verification_submit": "Confirmar",
  ...
  "txt_new_email": "Nueva dirección de correo",
  "txt_settings_appearance": "Apariencia",
  "txt_error_boundary_title": "No se pudo cargar esta página",
  "txt_error_boundary_chunk_help": "Se ha publicado una versión más reciente de NodeWarden. Recarga para continuar.",
  "txt_error_boundary_help": "Se produjo un error al mostrar esta página. Recarga para reintentar.",
  "txt_theme": "Tema",
  ...
  "txt_display_language_help": "Idioma de la interfaz y de los correos que recibes.",
  ...
  "txt_backup_destination_failed_at": "Último error: {time}",
  ...
  "txt_backup_replace_confirm_message": "La instancia actual ya contiene datos. ¿Continuar con la restauración y reemplazar los datos de la instancia actual con la copia de seguridad seleccionada después de que la verificación sea exitosa? Aviso: la verificación en dos pasos vuelve al estado de esa copia (clave del autenticador, código de recuperación, YubiKey, 2FA con clave de acceso) y se cerrarán todas las sesiones de todos los dispositivos. Comprueba primero que aún puedes iniciar sesión con el autenticador o el código de recuperación de esa copia.",
  ...
  "txt_server_error_cipher_key_invalid": "La clave de elemento enviada por el cliente no es una cadena cifrada válida. Actualiza el cliente e inténtalo de nuevo.",
  ...
  "txt_server_error_cannot_ban_self": "No puedes bloquear tu propia cuenta.",
  "txt_server_error_cannot_delete_self": "No puedes eliminar tu propia cuenta.",
  "txt_server_error_invalid_user_status": "El estado debe ser 'active' o 'banned'.",
  "txt_server_error_last_active_admin": "Este es el último administrador activo. Promueve primero a otro usuario como administrador.",
  "txt_server_error_user_not_found": "Usuario no encontrado.",
  "txt_server_error_invite_not_found": "Invitación no encontrada.",
  "txt_ios": "iOS",
  "txt_item": "Elemento",
  ...
  "txt_totp_secret_unavailable": "La verificación en dos pasos está activada, pero no se pudo mostrar ninguna clave de autenticador utilizable, así que la clave y el código QR están ocultos. Si no puedes iniciar sesión con tu aplicación de autenticación, desactiva la verificación en dos pasos abajo y vuelve a configurarla.",
  "txt_totp_verify_failed": "Error al verificar TOTP",
  "txt_totp_verify_success": "TOTP verificado",
  ...
  "txt_uri_match_type": "Detección de coincidencia",
  ...
  "txt_preferences_auto": "Automático ({value})",
  "txt_preferences_load_failed": "No se pudieron cargar las preferencias",
  "txt_preferences_save_failed": "No se pudieron guardar las preferencias",
  "txt_timezone": "Zona horaria",
  "txt_timezone_help": "Las horas en el correo y en la bóveda se muestran en esta zona horaria.",
  ...
  "txt_log_action_account_email_verification_confirm": "Confirmar dirección de correo",
  "txt_log_action_account_email_verification_send": "Enviar código de verificación de correo",
  ...
  "txt_log_action_account_webauthn_2fa_disable": "Desactivar verificación en dos pasos con passkey",
  ...
  "txt_log_action_account_yubikey_disable": "Desactivar YubiKey OTP",
  ...
  "txt_log_action_admin_mail_settings_update": "Actualizar configuración de correo",
  "txt_log_action_admin_mail_test": "Enviar correo de prueba",
  "txt_log_action_admin_mail_test_failed": "Falló el envío del correo de prueba",
  ...
  "txt_log_action_auth_login_failed_bad_auth_request": "Inicio de sesión fallido: solicitud de autorización rechazada",
  ...
  "txt_log_meta_deployed_at": "Desplegado el",
  "txt_log_meta_deployment_id": "ID de despliegue",
  "txt_log_meta_previous_version": "Versión anterior",
  "txt_log_meta_version": "Versión",
  ...
  "txt_log_action_account_api_key_view": "Ver clave de API",
  "txt_log_action_account_verify_devices_update_rejected": "Cambio de verificación de dispositivos nuevos rechazado",
  "txt_log_action_auth_client_ip_missing": "Error de inicio de sesión: falta la IP del cliente",
  "txt_log_action_backup_scheduled_skipped": "Copia de seguridad programada omitida",
  "txt_log_action_device_lost_trust": "Confianza del dispositivo caducada",
  "txt_log_action_device_register": "Registrar dispositivo",
  "txt_log_action_system_yubico_credentials_update": "Actualizar credenciales de validación de Yubico",
  "txt_log_reason_client_ip_missing": "Falta la IP del cliente",
  "txt_log_reason_email_auth_unsupported": "La verificación en dos pasos por código de correo no es compatible",
  "txt_log_reason_invalid_password": "Contraseña incorrecta",
  "txt_log_reason_lease_held": "Otro proceso retiene el bloqueo",
  "txt_log_reason_new_device_verification_unsupported": "La verificación de dispositivos nuevos no es compatible (sin canal de envío de correo)",
  "txt_log_reason_no_admin_present": "No hay ningún administrador activo",
  "txt_log_reason_password_missing": "No se proporcionó la contraseña",
  "txt_log_reason_rate_limit_unavailable": "Limitador de solicitudes no disponible",
  "txt_log_reason_security_stamp_mismatch": "El sello de seguridad no coincide",
  "txt_log_reason_storage_or_worker_error": "Error de almacenamiento o del Worker",
  "txt_log_reason_temporarily_unavailable": "Temporalmente no disponible",
  "txt_log_target_type_token_endpoint": "Punto de conexión de token",
  "txt_log_trigger_local": "Local",
  "txt_log_trigger_two_factor_device_verification_settings": "Ajustes de verificación de dispositivos de la verificación en dos pasos",
  ...
  "nav_password_security": "Seguridad de contraseñas",
  "txt_password_security": "Comprobación de seguridad",
  "txt_password_security_privacy": "Las contraseñas se comprueban localmente. Solo se envía un prefijo de hash anónimo a la base de filtraciones al iniciar la comprobación.",
  "txt_check_password_security": "Iniciar comprobación",
  "txt_checking_password_security": "Comprobando",
  "txt_recheck_password_security": "Comprobar de nuevo",
  "txt_password_security_ready": "Tu bóveda está lista para una comprobación de seguridad.",
  "txt_password_security_no_login": "No hay contraseñas de inicio de sesión para comprobar.",
  "txt_password_security_manual": "La comprobación solo empieza cuando la eliges. Los resultados se conservan solo en esta página.",
  "txt_password_security_no_login_help": "Añade un inicio de sesión con contraseña y vuelve aquí para comprobarlo.",
  "txt_exposed_passwords": "Filtradas",
  "txt_reused_passwords": "Reutilizadas",
  "txt_weak_passwords": "Débiles",
  "txt_passwords_checked": "Comprobadas",
  "txt_password_security_unavailable": "{count} comprobaciones no pudieron acceder a la base de filtraciones. No se marcan como seguras.",
  "txt_password_security_not_checked": "Sin comprobar",
  "txt_password_exposed_count": "Encontrada en {count} filtraciones",
  "txt_password_reused_count": "Usada {count} veces",
  "txt_weak_password": "Contraseña débil",
  "txt_no_password_risks": "No se encontraron riesgos de contraseña",
  "txt_open_vault": "Abrir bóveda",
  "txt_check_password_breach": "Comprobar filtración",
  "txt_password_not_found_in_breaches": "No encontrada en la base de filtraciones",
  "txt_password_security_check_failed": "No se pudo completar la comprobación de filtraciones.",
  "txt_password_security_last_checked": "Última comprobación: {value}",
  "txt_no_password_risks_in_filter": "No hay riesgos de contraseña en esta categoría",
  ...
  "txt_mail_configured": "Configurado",
  "txt_mail_sending_intro": "Configura un servidor SMTP para que NodeWarden pueda enviar correo.",
  "txt_mail_host": "Host SMTP",
  "txt_mail_port": "Puerto",
  "txt_mail_encryption_starttls": "STARTTLS (587 / 2587)",
  "txt_mail_encryption_implicit": "TLS implícito (465 / 2465)",
  "txt_mail_username": "Usuario",
  "txt_mail_password": "Contraseña",
  "txt_mail_password_keep": "Déjalo vacío para conservar la contraseña guardada",
  "txt_mail_from_address": "Dirección del remitente",
  "txt_mail_from_name": "Nombre del remitente",
  "txt_mail_send_test": "Enviar correo de prueba",
  "txt_mail_save_title": "Guardar ajustes de correo",
  "txt_mail_settings_load_failed": "No se pudieron cargar los ajustes de correo",
  "txt_mail_settings_save_failed": "No se pudieron guardar los ajustes de correo",
  "txt_mail_settings_saved": "Ajustes de correo guardados",
  "txt_mail_test_failed": "No se pudo enviar el correo de prueba",
  "txt_mail_test_sent": "Correo de prueba enviado a {email}",
  "txt_mail_error_timeout": "El servidor de correo no respondió a tiempo",
  "txt_mail_error_connect": "No se pudo conectar con el servidor de correo. Revisa el host y el puerto.",
  "txt_mail_error_auth": "El servidor de correo rechazó la sesión. Revisa el puerto y el cifrado.",
  "txt_mail_error_auth_rejected": "Error de autenticación. Revisa el usuario y la contraseña.",
  "txt_mail_error_delivery": "El servidor de correo rechazó el mensaje. Puede que la dirección del remitente no esté permitida.",
  "txt_mail_encryption_inferred": "Cifrado: {mode}",
  "txt_mail": "Correo",
  "txt_mail_disable": "Desactivar",
  "txt_mail_not_configured": "Sin configurar",
  "txt_mail_config": "Configuración de correo",
  "txt_log_reason_too_soon": "Solicitado demasiado pronto",
  "txt_log_reason_hourly_limit": "Límite por hora alcanzado",
  "txt_log_reason_daily_limit": "Límite diario alcanzado",
  "txt_log_target_type_mail_settings": "Ajustes de correo",
};
