...
const zhCN: Record<string, string> = {
  ...
  "txt_email_verification_send_code": "发送验证码",
  ...
  "txt_email_verification_unavailable_hint": "本服务器未配置邮件发送，暂时无法验证邮箱。",
  ...
  "txt_log_action_account_email_verification_cancel": "取消邮箱验证",
  ...
  "txt_log_action_auth_client_ip_missing": "登录被拒：缺少客户端 IP",
  ...
  "txt_log_action_backup_scheduled_skipped": "定时备份被跳过",
  ...
  "txt_log_action_device_lost_trust": "设备信任失效",
  ...
  "txt_log_action_system_yubico_credentials_initialize": "初始化 YubiKey API 凭据",
  "txt_log_action_system_yubico_credentials_reconfigure": "重新配置 YubiKey API 凭据",
  "txt_log_action_system_yubico_credentials_update": "更新 YubiKey API 凭据",
  ...
  "txt_log_reason_temporarily_unavailable": "服务暂时不可用",
  ...
  "txt_mail_locale": "邮件语言",
  "txt_mail_locale_help": "邮件的主题与正文使用的语言。",
  "txt_mail_timezone": "时区",
  "txt_mail_timezone_help": "邮件里显示的时间按此时区换算。"
};
