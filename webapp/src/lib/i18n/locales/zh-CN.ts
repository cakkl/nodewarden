...
const zhCN: Record<string, string> = {
  ...
  "txt_generator_type": "生成类型",
  "txt_passphrase": "密码短语",
  "txt_generated_password": "已生成密码",
  "txt_password_strength": "强度",
  "txt_password_strength_weak": "弱",
  "txt_password_strength_fair": "一般",
  "txt_password_strength_good": "良好",
  "txt_password_strength_strong": "强",
  "txt_generator_security_note": "生成过程仅在本地进行，密码不会发送到服务器。",
  "txt_generator_length": "长度",
  "txt_generator_character_types": "字符类型",
  "txt_generator_uppercase": "大写字母 (A-Z)",
  "txt_generator_lowercase": "小写字母 (a-z)",
  "txt_generator_numbers": "数字 (0-9)",
  "txt_generator_special": "特殊字符 (!@#$%^&*)",
  "txt_generator_minimum": "最少数量",
  "txt_generator_avoid_ambiguous": "避免易混淆字符",
  "txt_generator_words": "单词数量",
  "txt_generator_separator": "单词分隔符",
  "txt_generator_capitalize": "首字母大写",
  "txt_generator_include_number": "包含数字",
  "txt_generated_value": "已生成内容",
  "txt_generator_character_count": "{count} 个字符",
  "txt_generator_pin": "PIN 码",
  "txt_generator_pin_description": "使用密码学安全随机数在本地生成纯数字 PIN 码。",
  "txt_generator_username": "用户名",
  "txt_generator_plus_addressed_email": "加号别名邮箱",
  "txt_generator_catch_all_email": "全域接收邮箱",
  "txt_generator_email": "邮箱地址",
  "txt_generator_domain": "域名",
  "txt_generator_word_list": "词表",
  "txt_generator_eff_word_list": "EFF 长词表",
  "txt_generator_custom_word_list": "自定义词表",
  "txt_generator_custom_words": "自定义单词",
  "txt_generator_custom_words_placeholder": "输入至少两个单词，用空格、逗号或换行分隔",
  "txt_generator_long_word_username": "长单词用户名",
  "txt_generator_custom_word": "自定义助记词",
  "txt_generator_subdomain_email": "子域电子邮件",
  "txt_generator_ssh_key": "SSH 密钥",
  "txt_generator_ssh_generating": "正在生成 SSH 密钥…",
  "txt_generator_ssh_error": "此浏览器不支持 SSH 密钥生成。",
  "txt_generator_copy_public_key": "复制公钥",
  "txt_generator_ssh_security_note": "密钥对仅在本地生成，不会发送到服务器。请立即保存私钥，NodeWarden 不会保留它。",
  "txt_generator_public_key": "公钥",
  "txt_generator_private_key": "私钥 — 请保密",
  "txt_generator_ssh_algorithm": "算法",
  "txt_generator_key_length": "密钥长度",
  "txt_generator_ssh_comment": "公钥注释",
  "txt_generator_ssh_rsa_description": "RSA 兼容性广泛。请至少使用 2048 位，推荐 4096 位。",
  "txt_generator_ssh_ed25519_description": "Ed25519 快速且紧凑，推荐用于现代 SSH 客户端。",
  "txt_generator_email_alias": "邮箱别名",
  "txt_generator_email_type": "邮箱别名类型",
  "txt_generator_email_required_hint": "输入邮箱地址或域名后，即可生成别名。",
  "txt_generator_email_description": "输入内容只保留在此设备上，仅用于组合邮箱别名。",
  "txt_generator_long_word_username_description": "将一个或多个长单词组合成易记的用户名。",
  ...
  "txt_email_verification_code_label": "验证码",
  "txt_email_verification_submit": "确认",
  ...
  "txt_error_boundary_title": "页面加载失败",
  "txt_error_boundary_chunk_help": "NodeWarden 发布了新版本，刷新页面即可继续。",
  "txt_error_boundary_help": "渲染这个页面时出错，刷新后重试。",
  "txt_theme": "主题",
  "txt_use_system_theme": "使用系统主题",
  "txt_light_theme": "浅色",
  "txt_dark_theme": "深色",
  "txt_theme_saved_locally": "为您的网页密码库选择一个主题。",
  "txt_display_language_help": "界面与发给你的邮件所用的语言。",
  ...
  "txt_backup_replace_confirm_message": "当前实例里已经有数据。确认后，系统会先完成校验与恢复准备，只有在恢复成功后才会用所选备份替换当前实例数据。是否继续？注意：两步验证会回退到该备份中的状态（验证器密钥、恢复码、YubiKey、二步验证通行密钥），并强制注销所有设备的登录会话；请先确认你仍能用该备份里的验证器或恢复码登录。",
  ...
  "txt_server_error_cipher_key_invalid": "客户端发来的条目密钥不是合法的加密串。请更新客户端后重试。",
  ...
  "txt_server_error_cannot_ban_self": "不能封禁自己",
  "txt_server_error_cannot_delete_self": "不能删除自己",
  ...
  "txt_totp_secret_unavailable": "两步验证已启用，但无法显示可用的验证器密钥，因此密钥与二维码已隐藏。若你无法用验证器 App 登录，请在下方先停用，再重新启用。",
  "txt_totp_verify_failed": "TOTP 验证失败",
  "txt_totp_verify_success": "TOTP 验证通过",
  "txt_attachments": "附件",
  ...
  "txt_preferences_auto": "自动（{value}）",
  "txt_preferences_load_failed": "加载偏好失败",
  "txt_preferences_save_failed": "保存偏好失败",
  "txt_timezone": "时区",
  "txt_timezone_help": "邮件与密码库里的时间都按此时区显示。",
  ...
  "txt_log_action_account_email_verification_confirm": "确认邮箱地址",
  "txt_log_action_account_email_verification_send": "发送邮箱验证码",
  ...
  "txt_log_action_account_webauthn_2fa_disable": "停用通行密钥两步验证",
  ...
  "txt_log_action_admin_mail_settings_update": "更新邮件设置",
  "txt_log_action_admin_mail_test": "发送测试邮件",
  "txt_log_action_admin_mail_test_failed": "测试邮件发送失败",
  "txt_log_action_admin_user_delete": "删除用户",
  "txt_log_action_admin_user_status": "修改用户状态",
  "txt_log_action_attachment_delete": "删除附件",
  "txt_log_action_auth_login_failed_bad_api_key": "登录失败：API 密钥错误",
  "txt_log_action_auth_login_failed_bad_auth_request": "登录失败：授权请求校验未通过",
  "txt_log_action_auth_login_failed_bad_password": "登录失败：密码错误",
  "txt_log_action_auth_login_failed_user_inactive": "登录失败：账号已停用",
  ...
  "txt_log_action_account_api_key_view": "查看 API 密钥",
  "txt_log_action_account_verify_devices_update_rejected": "拒绝修改新设备验证",
  "txt_log_action_auth_client_ip_missing": "登录失败：缺少客户端 IP",
  "txt_log_action_backup_scheduled_skipped": "计划备份已跳过",
  "txt_log_action_device_lost_trust": "设备信任已失效",
  "txt_log_action_device_register": "注册设备",
  "txt_log_action_system_yubico_credentials_update": "更新 Yubico 验证凭据",
  "txt_log_reason_client_ip_missing": "缺少客户端 IP",
  "txt_log_reason_email_auth_unsupported": "不支持邮件验证码两步登录",
  "txt_log_reason_invalid_password": "密码错误",
  "txt_log_reason_lease_held": "已有任务占用租约",
  "txt_log_reason_new_device_verification_unsupported": "不支持新设备验证（没有邮件发送通道）",
  "txt_log_reason_no_admin_present": "没有可用的管理员",
  "txt_log_reason_password_missing": "未提供密码",
  "txt_log_reason_rate_limit_unavailable": "限流服务不可用",
  "txt_log_reason_security_stamp_mismatch": "安全戳不一致",
  "txt_log_reason_storage_or_worker_error": "存储或 Worker 错误",
  "txt_log_reason_temporarily_unavailable": "暂时不可用",
  "txt_log_target_type_token_endpoint": "令牌端点",
  "txt_log_trigger_local": "本地",
  "txt_log_trigger_two_factor_device_verification_settings": "两步验证的设备验证设置",
  "txt_metadata": "元数据",
  ...
  "txt_mail_configured": "已配置",
  "txt_mail_sending_intro": "配置 SMTP 服务器后，NodeWarden 才能发送邮件。",
  "txt_mail_host": "SMTP 主机",
  "txt_mail_port": "端口",
  "txt_mail_encryption_starttls": "STARTTLS（587 / 2587）",
  "txt_mail_encryption_implicit": "隐式 TLS（465 / 2465）",
  "txt_mail_username": "用户名",
  "txt_mail_password": "密码",
  "txt_mail_password_keep": "留空表示保持已保存的密码",
  "txt_mail_from_address": "发件人地址",
  "txt_mail_from_name": "发件人名称",
  "txt_mail_send_test": "发送测试邮件",
  "txt_mail_save_title": "保存邮件设置",
  "txt_mail_settings_load_failed": "无法加载邮件设置",
  "txt_mail_settings_save_failed": "无法保存邮件设置",
  "txt_mail_settings_saved": "邮件设置已保存",
  "txt_mail_test_failed": "无法发送测试邮件",
  "txt_mail_test_sent": "测试邮件已发送至 {email}",
  "txt_mail_error_timeout": "邮件服务器未在时限内响应",
  "txt_mail_error_connect": "无法连接邮件服务器，请检查主机与端口。",
  "txt_mail_error_auth": "邮件服务器拒绝了本次会话，请检查端口与加密方式。",
  "txt_mail_error_auth_rejected": "认证失败，请检查用户名与密码。",
  "txt_mail_error_delivery": "邮件服务器拒收了这封信，发件人地址可能不被允许。",
  "txt_mail_encryption_inferred": "加密方式：{mode}",
  "txt_mail": "邮件",
  "txt_mail_disable": "禁用",
  "txt_mail_not_configured": "未配置",
  "txt_mail_config": "邮件配置",
  "txt_log_reason_too_soon": "请求过于频繁",
  "txt_log_reason_hourly_limit": "已达每小时限额",
  "txt_log_reason_daily_limit": "已达每日限额",
  "txt_log_target_type_mail_settings": "邮件设置",
};
