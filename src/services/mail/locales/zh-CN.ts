...
const zhCN: MailCopy = {
  ...
  notifications: {
    ...
    detailsTitle: '详情',
    labels: { time: '时间', ip: 'IP 地址', device: '设备', type: '类型', location: '位置' },
    ...
    deviceTypes: {
      ...
      firefoxExtension: 'Firefox 扩展',
      operaExtension: 'Opera 扩展',
      edgeExtension: 'Edge 扩展',
      windowsDesktop: 'Windows 桌面端',
      macosDesktop: 'macOS 桌面端',
      linuxDesktop: 'Linux 桌面端',
      chromeBrowser: 'Chrome 浏览器',
      firefoxBrowser: 'Firefox 浏览器',
      operaBrowser: 'Opera 浏览器',
      edgeBrowser: 'Edge 浏览器',
      ieBrowser: 'IE 浏览器',
      web: '网页',
    },
    events: {
      ...
      new_sign_in: '来自新设备或新地区的登录',
      two_step_recovery_created: '新的恢复码已生成',
      passkey_created: '登录通行密钥已创建',
      passkey_deleted: '登录通行密钥已删除',
    },
  },
  preferencesNote: {
