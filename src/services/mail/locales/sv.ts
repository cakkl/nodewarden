...
const sv: MailCopy = {
  ...
  notifications: {
    ...
    labels: { time: 'Tid', ip: 'IP-adress', device: 'Enhet', type: 'Typ', location: 'Plats' },
    ...
    deviceTypes: {
      android: 'Android',
      ios: 'iOS',
      chromeExtension: 'Chrome-tillägg',
      firefoxExtension: 'Firefox-tillägg',
      operaExtension: 'Opera-tillägg',
      edgeExtension: 'Edge-tillägg',
      windowsDesktop: 'Windows Skrivbord',
      macosDesktop: 'macOS Skrivbord',
      linuxDesktop: 'Linux Skrivbord',
      chromeBrowser: 'Chrome-webbläsare',
      firefoxBrowser: 'Firefox-webbläsare',
      operaBrowser: 'Opera-webbläsare',
      edgeBrowser: 'Edge-webbläsare',
      ieBrowser: 'IE-webbläsare',
      web: 'Webb',
    },
    events: {
      ...
      new_sign_in: 'Inloggning från en ny enhet eller plats',
      two_step_recovery_created: 'Återställningskod för tvåstegsinloggning skapad',
      passkey_created: 'Inloggningsnyckel skapad',
      passkey_deleted: 'Inloggningsnyckel borttagen',
    },
  },
  preferencesNote: {
