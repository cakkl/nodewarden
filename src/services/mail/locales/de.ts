...
const de: MailCopy = {
  ...
  notifications: {
    ...
    labels: { time: 'Zeit', ip: 'IP-Adresse', device: 'Gerät', type: 'Typ', location: 'Standort' },
    ...
    deviceTypes: {
      ...
      firefoxExtension: 'Firefox-Erweiterung',
      operaExtension: 'Opera-Erweiterung',
      edgeExtension: 'Edge-Erweiterung',
    ...
    events: {
      ...
      new_sign_in: 'Anmeldung von einem neuen Gerät oder Standort',
      two_step_recovery_created: 'Wiederherstellungscode für die Zwei-Faktor-Anmeldung erstellt',
      passkey_created: 'Anmelde-Passkey erstellt',
      passkey_deleted: 'Anmelde-Passkey gelöscht',
    },
  },
  preferencesNote: {
