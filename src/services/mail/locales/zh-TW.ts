...
const zhTW: MailCopy = {
  ...
  notifications: {
    ...
    detailsTitle: '詳情',
    labels: { time: '時間', ip: 'IP 位址', device: '裝置', type: '類型', location: '位置' },
    ...
    deviceTypes: {
      android: '安卓',
      ios: 'iOS',
      chromeExtension: 'Chrome 擴展',
      firefoxExtension: 'Firefox 擴展',
      operaExtension: 'Opera 擴展',
      edgeExtension: 'Edge 擴展',
      windowsDesktop: 'Windows 桌面端',
      macosDesktop: 'macOS 桌面端',
      linuxDesktop: 'Linux 桌面端',
      chromeBrowser: 'Chrome 瀏覽器',
      firefoxBrowser: 'Firefox 瀏覽器',
      operaBrowser: 'Opera 瀏覽器',
      edgeBrowser: 'Edge 瀏覽器',
      ieBrowser: 'IE 瀏覽器',
      web: '網頁',
    },
    events: {
      ...
      new_sign_in: '來自新裝置或新地區的登入',
      two_step_recovery_created: '新的復原碼已產生',
      passkey_created: '登入通行密鑰已建立',
      passkey_deleted: '登入通行密鑰已刪除',
    },
  },
  preferencesNote: {
